...
describe('Rousr API', function() {
    ...
    describe('Congressional District by Address', function() {
        ...
        it('should return TX district 35', function(done) {
        ...
        it('should return AL district 5', function(done) {

            // increase the timeout for this query
            this.timeout(5000);

            const expectedResponseCode = '200';
            const expectedState = 'AL';
            const expectedDistrict = 5;

            const form = {
                address: '155 Whisperwood Ln, Madison, AL'
            };
